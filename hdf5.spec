...
Pliki nag≥Ûwkowe biblioteki HDF5 oraz dokumentacja HDF5.
...
Summary(pl):	NarzÍdzia do konwersji pomiÍdzy HDF 4.x i HDF5
Group:		Applications/File
Group(de):	Applikationen/Datei
Group(pl):	Aplikacje/Pliki
Requires:	%{name} = %{version}
...
NarzÍdzia do konwersji plikÛw z formatu HDF 4.x do HDF5 oraz z HDF5 do
HDF 4.x.
